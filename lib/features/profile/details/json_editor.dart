...
const _downArrow = SizedBox(width: _expandIconWidth, child: FaIcon(FontAwesomeIcons.caretDown, size: 14));
const _rightArrow = SizedBox(width: _expandIconWidth, child: FaIcon(FontAwesomeIcons.caretRight, size: 14));
...
class _HolderState extends State<_Holder> {
  ...
  void onSelected(_OptionItems selectedItem) {
    ...
    if (selectedItem == "delete") {
      if (parentObject is Map) {
        ...
        (parentObject as List).removeAt(widget.keyName as int);
      }
      ...
      if (data is Map) {
        ...
        (data as List).add(<String, dynamic>{});
      }
      ...
      if (data is Map) {
        ...
        (data as List).add(_newDataValue[selectedItem]);
      }
  ...
  void onKeyChanged(Object key) {
    final parentObject = widget.parentObject as Map;
